...
function initLogin() {
    ...
    inputs.forEach(input => input.addEventListener("input", clearAllLoginErrors));

    initPasswordToggle();
    document.getElementById("login-password").addEventListener("input", () => updatePasswordIcon("login-password", "toggle-login-password"));
}
